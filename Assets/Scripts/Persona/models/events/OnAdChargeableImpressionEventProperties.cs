...
namespace IO.Persona.MobileAds.Unity
{
    public class OnAdChargeableImpressionEventProperties
    {
        ...
        public OnAdChargeableImpressionEventProperties(string placementId, string walletAddress, string userEmail, DeviceMetadata deviceMetadata, string creativeId, float visiblePercentage, string triggeredAt, string release)
        {
